...
exports.licenseController.use((req, res, next) => {
    if (OWNER_ROUTES.includes(req.path) && req.user) {
        if (!req.user.isOwner) {
            typedi_1.Container.get(Logger_1.Logger).info('Non-owner attempted to activate or renew a license', {
                userId: req.user.id,
            });
    ...
    try {
        ...
        switch ((_a = error.errorId) !== null && _a !== void 0 ? _a : 'UNSPECIFIED') {
            ...
            default:
                ...
                typedi_1.Container.get(Logger_1.Logger).error(message, { stack: (_b = error.stack) !== null && _b !== void 0 ? _b : 'n/a' });
        }
