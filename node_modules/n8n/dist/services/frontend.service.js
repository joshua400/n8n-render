...
let FrontendService = class FrontendService {
    constructor(logger, loadNodesAndCredentials, credentialTypes, credentialsOverwrites, license, mailer, instanceSettings) {
        this.logger = logger;
    ...
    initSettings() {
        ...
        this.settings = {
            ...
            publicApi: {
                enabled: !config_1.default.get('publicApi.disabled') && !this.license.isAPIDisabled(),
                latestVersion: 1,
    ...
    getSettings() {
        ...
        if (this.license.isVariablesEnabled()) {
            this.settings.variables.limit = (0, enviromentHelpers_1.getVariablesLimit)();
        }
