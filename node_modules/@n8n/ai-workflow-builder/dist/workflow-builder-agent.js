    ...
    createLegacyWorkflow(featureFlags) {
        ...
        const shouldContinue = ({ messages }) => {
            ...
            if (!(lastMessage instanceof messages_1.AIMessage)) {
                throw new errors_1.WorkflowStateError('Expected last message to be generated by the AI agent');
            }
