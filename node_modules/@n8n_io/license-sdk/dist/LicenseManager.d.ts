...
declare class LicenseManager {
    ...
    renew({ detachFloatingEntitlements, }?: {
...
export { LicenseManager, TEntitlement, TFeatures, TLicenseBlock, TLicenseCertObj, TLicenseContainer, TLicenseManagerConfig, TLogger, TMetadata, TUsageMetric };
